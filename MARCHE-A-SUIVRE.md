...
Options utiles :
    ...
    node outils/cycle.js --sec                 # montre tout, n'écrit rien
    node outils/cycle.js --recettes-seulement  # saute les images
    node outils/cycle.js --images-seulement    # saute la rédaction
    node outils/cycle.js --lot=2026-10         # force le lot de destination
    node outils/cycle.js --max=5               # limite le nombre d'images
...
3. `node outils/cycle.js --images-seulement`
...
3. Remplis :
   ...
   - **Start Command** : `node serveur/serveur.js`
...
Ouvre `app/index.html` directement et un bandeau orange te le dira :

...
"",
"LA NORME DES ÉTAPES (docs/RECIPE-STANDARD.md) — chaque recette est refusée sinon",
"  1. Chaque ingrédient est nommé dans une étape, avec sa préparation (pelée et râpée, émincé, égoutté).",
"  2. La préparation avant la cuisson : four allumé, plaque tapissée, légumes coupés.",
"  3. Le matériel et les tailles : moule de 23 × 13 cm, grand bol, moule à 12 muffins.",
"  4. Les températures en deux unités : 200 °C (400 °F).",
"  5. Chaque étape qui cuit a une durée ET un repère : « 18 à 20 minutes, jusqu'à ce que le dessus soit doré ».",
"  6. Une action par étape, 6 à 10 étapes, 20 mots ou moins. À l'impératif.",
"  7. Le rendement en portions familiales, et une note de conservation à la dernière étape.",
"  Jamais « mélanger tous les ingrédients ».",
"",
"CATÉGORIE",
"  Meal : le plat du soir, celui qu'on cuisine.",
"  Snack : la collation au sens large — bouchée, muffin, gruau, fruit préparé,",
"  dessert simple, tout ce qui se mange à 10 h ou à 15 h. Pas de déjeuner :",
"  ce qui ressemble à un déjeuner est une collation.",
"",
"FORMAT DE SORTIE",
